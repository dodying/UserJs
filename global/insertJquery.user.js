...
// @grant       unsafeWindow
// resource jquery https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.js
// @noframes
// ==/UserScript==
(function () {
  /* eslint-disable */
    ...
    jQuery.ajaxPrefilter('json jsonp', (s, originalSettings, jqXHR) => {
      ...
      if (jsonProp || s.dataTypes[0] === 'jsonp') {
        ...
        if (jsonProp) {
          ...
          s.url = `${s.url}${(rquery.test(s.url) ? '&' : '?') + s.jsonp}=${callbackName}`;
        }
