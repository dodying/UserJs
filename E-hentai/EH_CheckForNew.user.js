...
script.src = 'https://raw.githubusercontent.com/dodying/UserJs/master/Lib/sortTable.js';
...
EH_CheckForNew_Button.querySelector('#EH_CheckForNew_Add').onclick = function () {
  ...
  if (document.querySelector('h1#gn')) {
    var BookName = document.querySelector('h1#gn').innerText.replace(/\[.*?\]|\(.*?\)|【.*?】/g, '').replace(/^\s+|\s+$/g, '');
    var LastPost = document.querySelector('.itd').innerText;
    var Keyword = BookName;
  } else {
    var BookName = '';
    var LastPost = document.querySelector('tr.gtr1:nth-child(3) > td:nth-child(2)').innerText;
    var Keyword = document.querySelector('input.stdinput,form>input[name="favcat"]+div>input').value;
  }
...
EH_CheckForNew_Button.querySelector('#EH_CheckForNew_All').onclick = function () {
  if (document.querySelector('#EH_CheckForNew_Table')) {
    ...
    EH_CheckForNew_Table.innerHTML = '<table><tbody><tr><td><input type="checkbox"></td><td onclick="sortTable(\'EH_CheckForNew_Table_Content\',1,\'int\');">ID</td><td onclick="sortTable(\'EH_CheckForNew_Table_Content\',2,\'date\');">LastUpdateTime</td><td onclick="sortTable(\'EH_CheckForNew_Table_Content\',3,\'date\');">LastPostTime</td><td onclick="sortTable(\'EH_CheckForNew_Table_Content\',4);">Url</td><td onclick="sortTable(\'EH_CheckForNew_Table_Content\',5);">Keyword</td></tr></tbody></table><div style="height:600px;overflow:auto;"><table id="EH_CheckForNew_Table_Content"><tbody></tbody></table></div><button class="stdbtn" id="EH_CheckForNew_Batch_Update">更新</button><button class="stdbtn" id="EH_CheckForNew_Batch_Delete">删除</button>';
    var FavSort = GM_getValue('FavSort', [
    ]);
