...
3. 攻击规则：攻击血量减少最大的怪兽，判断条件：Boss数≥2
4. 攻击模式：**可能**增加多重攻击模式，以前[syaofox](https://github.com/syaofox)提出过，但是被我否决。最近换了武器，有几种元素的攻击加成相近，尴尬
5. 小马：遭遇时，利用alert跳转到此标签（Firefox的功能）
6. 任意页面停留竞技场填写方式变更
7. 内置[translater.js](https://github.com/jaywcjlove/translater.js)，原因是原来的方法脚本不好编写（顺便去除简体，大家应该都看得懂繁体吧）
99. 推荐一些自己写的hv的其他相关脚本
