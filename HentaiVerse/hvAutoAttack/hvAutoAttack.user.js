...
try {
  ...
  function addStyle(lang) { // CSS
    ...
    const cssContent = [
      ...
      '.encounterUI{font-weight:bold;font-size:10pt;position:absolute;top:8px;left:1160px;text-decoration:none;}',
