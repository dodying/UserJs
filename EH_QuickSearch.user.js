...
// ==/UserScript==
var bookname = document.querySelector('input.stdinput').value || document.querySelector('#gn').innerHTML || '';
...
EH_QuickSearch_box.style = 'z-index:999;width:600px;display:none;background-color:' + bgcolor + ';position:absolute;left:' + eval(document.documentElement.clientWidth / 2 - 300) + 'px;top:270px;border-color:black;border-style: solid;';
EH_QuickSearch_box.innerHTML = '<div id="EH_QuickSearch_popular"><div style="font-size:larger;">常用</div></div><br /><br /><div id="EH_QuickSearch_used"><div style="font-size:larger;">已使用</div></div><br /><br /><br /><div id="EH_QuickSearch_other"><div style="font-size:larger;">其他</div></div><br /><br /><button id="EH_QuickSearch_apply">应用</button><button id="EH_QuickSearch_cancel">取消</button>';
...
function EH_QuickSearch_Add2Popular(name, name_cn, url) {
  ...
  a.target = '_blank';
  a.style = 'float:left;';
  //a.innerHTML = name_cn + '[' + name + ']';
  a.innerHTML = name_cn;
  document.querySelector('#EH_QuickSearch_popular').appendChild(a);
  var div = document.createElement('div');
  div.style = 'float:left;';
  div.innerHTML = '--';
  document.querySelector('#EH_QuickSearch_popular').appendChild(div);
}
