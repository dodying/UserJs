...
function EH_QuickSearch_Add2Used(name, name_cn) {name=name.replace(/"/g,'\'\'');
  var div = document.createElement('div');
  div.style = 'float:left;';
  div.className = 'EH_QuickSearch_Keyword_Used';
  //div.innerHTML = name_cn + '[' + name + ']';
  div.innerHTML = '<input type="checkbox" checked="true" name="' + name + '" />' + name_cn;
...
function EH_QuickSearch_Add(type, name, name_cn) {
  ...
  switch (type) {
    case '+':
      ...
      //div.innerHTML = name_cn + '[' + name + ']';
      div.innerHTML = '<input type="checkbox" name="' + name + '" />' + name_cn;
